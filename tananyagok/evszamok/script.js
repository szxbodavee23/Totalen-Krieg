...
const displayCover = (display) => {
    if (display) {
        cover.style = "display: block; position: absolute; top: 0%, left: 0%; width: 100%; height: 100%; background-color: rgba(0,0,0,0.7); z-index: -10;";
    ...
    li.addEventListener("click", (e) => {
        ...
        if (!displayPanelVisibility) {
            if (ihtml.startsWith("1939")) {
                ...
                "a néven, de London Blitzként vagy Big Blitzként is hivatkoznak a német légierő brit célpontok ellen 1940–1941-ben végrehajtott éjszakai légitámadásainak időszakára." + "<br>" +
                ...
                "megakadályozta, hogy a németek elfoglalják Moszkvát, illetve Leningrádot." + "<br>" + 
                ...
                "nélküli megsemmisítő támadás szinonímája lett." + "<br>" +
                ...
                "a japánok, gyengén működő hírszerzésük miatt, lényegében semmit nem tudtak az amerikaiak felkészültségéről és helyzetéről." + "<br>" +
                ...
                "katona kapitulációja követett. A foglyok között 22 tábornok volt. Hitler dühöngött: \"Paulus az örök dicsőség küszöbén csinált hátraarcot\" mondta." + "<br>" +
                ...
                "katona esett el, sebesült meg vagy tűnt el. Több mint hatvan százalékuk amerikai volt. A pontos német adat nem ismert, a becslések szerint a veszteség 4-9 ezer főre rúgott." + "<br>" +
                ...
                "emlékmű tiszteleg a német előrenyomulást megállító amerikai katonák előtt." + "<br>" +
                ...
                "hogy a német kapituláció csak egyidejűleg, valamennyi fronton történhet meg." + "<br>" +
                "<img src='../../pics/kapitulacio.jpg' style='margin-top: 2rem; width: 50%; min-width: 300px;'>";
            }
            else if (ihtml.startsWith("1945. augusztus 6.")) {
                displayPanel.innerHTML = closeButton + 
                "1945 augusztusára a szövetségesek Manhattan terve már túl volt az atombomba kifejlesztésén és tesztelésén, és " +
                ...
                "többségükben civilek vesztették életüket." + "<br>" +
                ...
                "kérdések máig heves viták tárgyát képzik." + "<br>" +
